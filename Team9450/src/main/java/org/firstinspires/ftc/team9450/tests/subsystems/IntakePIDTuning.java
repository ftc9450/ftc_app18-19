...
@Autonomous
public class IntakePIDTuning extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while(opModeIsActive()) {
            ...
            if(gamepad1.dpad_up){
                NEW_P += increment;
                pidModified = new PIDFCoefficients(NEW_P, NEW_I, NEW_D, 0);
                intake.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, pidModified);
